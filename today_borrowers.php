...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_borrower_submit'])) {
    ...
    header("Location: today_borrowers.php");
    exit;
}
...
// 3) Fetch all borrowers created today
$listQ = "SELECT * FROM tbl_borrower WHERE DATE(created_at) = CURDATE() ORDER BY id DESC";
...
<div class="content-wrapper">
    <div class="container-fluid">
        <h2 class="mt-3 mb-4 font-weight-bold">Borrowers Joined Today (Total: <?php echo $totalBorrowers; ?>)</h2>
        <div class="row mb-3">
            <div class="col-md-6">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2 align-self-end">
                                    ...
                                    <a href="today_borrowers.php" class="btn btn-secondary btn-block mt-2">
                                        Cancel
                                    </a>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php else: ?>
                    <div class="alert alert-danger">No borrowers found for today.</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
